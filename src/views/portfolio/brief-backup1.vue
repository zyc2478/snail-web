    ...
    export default{
        ...
        methods: {
            ...
            getList(){
                ...
                this.$http.post('http://localhost:8080/bbd_ds/vwBidList/getVwBidList/30',{})
                    .then(function (res) {
                        /*                        lineCharts.addSeries(res.data);
                                                lineCharts.hideLoading();*/
                        var series = lineCharts.series[0],
                            shift = series.data.length > 20; // 当数据点数量超过 20 个，则指定删除第一个点

                        // 新增点操作
                        //具体的参数详见：https://api.hcharts.cn/highcharts#Series.addPoint
                        lineCharts.series[0].addPoint(res, true, shift);
